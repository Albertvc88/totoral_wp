    ...
    <main class="mb-6">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-7 mt-lg-n5 order-md-1">
                            ...
                            <p class="subtitle"><?php echo __('Creamos experiencias digitales necesarias', 'understrap-child' ) ?></p>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <?php 
                                ...
                                $project = new WP_Query( array( 'post_type' => 'proyecto', 'orderby' => 'date', 'posts_per_page' => 999, 'order' => 'DESC') ); 
            ...
            <div class="container-fluid  px-0">
                <div class="row no-gutters align-items-center position-relative">
                    ...
                    <div class="col-md-5 pl-5">
                        <div class="img">
                            <img src="<?php bloginfo('stylesheet_directory'); ?>/images/pepe-min-c.jpg" class="img-fluid rounded-circle" alt="">
                        </div>
                    </div>
        ...
        <section class="py-6">
            ...
            <div class="container">
                <div class="services-title title-one text-center pt-3 pb-5">
                    <div class="container">
                        <p class="subtitle-top mb-0"><?php echo __( 'SIGUE A @TOTORALFILMS EN INSTAGRAM', 'understrap-child' ) ?></p>
                        <h2 class="title pb-4 no-line"><?php echo __( 'EN QUÉ ESTAMOS', 'understrap-child' ) ?></h2>
                    </div>
                </div>
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-12">                          
                        <?php dynamic_sidebar('instagram_slider') ?>  
                    </div>
                </div>
            </div>
        </section>
